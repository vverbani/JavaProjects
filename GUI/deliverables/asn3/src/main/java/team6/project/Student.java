...
public class Student implements Serializable {
	...
	/**
	 * Constructor to construct a student object that does not belong to a specific course
	...
	public void addGrade(double grade, Deliverable del){
		grades.add(new Grade(grade, del));
	}
	...
	public String toString() {
		return firstName + " " + lastName + "  |  " + studentNumber + "  |  " + emailAddress;
	}
}
